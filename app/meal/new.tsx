          ...
          {(["breakfast", "lunch", "dinner", "snack"] as const).map((t) => (
            <Pressable
              ...
              style={{
                ...
                borderRadius: 12,
                borderWidth: 1,
                borderColor: t === type ? colors.primary : "#e5e7eb",
                backgroundColor: t === type ? "#e0f2fe" : "#fff",
              }}
            >
              <Text
                style={{
